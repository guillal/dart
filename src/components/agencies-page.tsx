                      ...
                      {agency.url ? (
                        ...
                        >
                          <h3 className="font-heading font-bold text-lg lg:text-xl text-white group-hover:text-yellow transition-colors duration-500">
                            {agency.name}
                            <svg className="inline-block ml-2 w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
